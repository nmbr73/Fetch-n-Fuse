...
__KERNEL__ void RythmicFlFuse__Buffer_A(float4 out_color, float2 coordinates, float2 iResolution, sampler2D iChannel0, sampler2D iChannel1, sampler2D iChannel2)
{
...
__KERNEL__ void RythmicFlFuse(float4 out_color, float2 coordinates, float2 iResolution, sampler2D iChannel0)
{
