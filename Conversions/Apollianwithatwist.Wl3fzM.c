...
!!
!! Please do not change this file. It's for nmbr73 to test the conversion (and thereby meant to not work)!
!!
...
__KERNEL__ void ApollianwithatwistKernel(out vec4 fragColor, in vec2 fragCoord) {
