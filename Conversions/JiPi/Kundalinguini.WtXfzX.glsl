...
void mainImage( out vec4 col, in vec2 pos )
{
    ...
    // Output to screen
    col.xyz += 0.1*a;
    col.xyz += 0.5 - 0.5*cos(0.31*010.0*vec3(0.36131*sin(iTime*0.1),0.22+cos(iTime*0.1),0.1606+cos(iTime*(0.51)))*rho.w);
...
//mold stuff 
#define sense_ang (time*0.34)
#define sense_dis 010.0*sin(time*01.1)
