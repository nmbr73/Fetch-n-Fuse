...
#define sense_num 11
#define sense_ang 01.5*(01.5*cos(iTime/6.))
//#define sense_dis 12.0*(010.51*cos(iTime*0.51))
#define sense_dis 50.+(040.*cos(iTime/3.))
#define sense_oscil 00.0
#define oscil_scale 0.421
#define oscil_pow 0.50
#define sense_force 0.01
#define distance_scale 00.59
